<div class="modal-vuukle" id="modal-save-settings" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            <a href="#"><button type="button" class="button button-secondary" id="vuukle-discart-settings-button">Discard</button></a>
            <button type="button" class="button button-primary" id="vuukle-save-settings-button">Save</button></a>
        </div>
    </div>
</div>
